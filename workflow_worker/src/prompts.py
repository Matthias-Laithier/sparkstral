...
def combined_research_prompt(company_query: str) -> str:
    return (
        ...
        "needed for a GenAI recommendation workflow. Search for recent developments "
        "(last 12 months) first: acquisitions, earnings results, strategic pivots, "
        "new market entries, major contracts, regulatory changes, and leadership "
        "moves. Then cover: business lines; key customers and segments; named "
        "products, platforms, or proprietary technologies; strategic priorities and "
        "initiatives; geography and markets; operational pain points; regulatory "
        "and customer pressure; growth opportunities; technology and digital "
...
def genai_use_cases_system_prompt() -> str:
    return (
        ...
        "use case must also show a structurally different GenAI workflow — not the "
        "same 'ingest data, detect patterns, generate recommendations' loop with "
        "different data types swapped in.\n"
