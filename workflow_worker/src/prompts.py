...
def genai_use_cases_user_prompt(
    ...
    return (
        ...
        "prior inputs); and ideation_lens. Each genai_solution must describe a "
        "concrete user workflow: who uses it, what they input, what the system "
        "generates, and what human approval step exists. Use the company "
        "profile, business lines, strategic priorities, pain points, and "
        "evidence URLs directly. "
    )
...
def markdown_reporter_system_prompt() -> str:
    return (
        ...
        "supporting sources. For each use case, include a short section titled "
...
def markdown_reporter_user_prompt(
    ...
    return (
        ...
        "feasibility, risks, a short `Why this is GenAI` section based on "
        "genai_mechanism, and supporting source URLs. "
